  ...
  return (
    <section id="cascade">
      ...
      <p className="sec-lead">
        ...
        runs left to right, edges are ordered, repeated leaves aggregate, and Fit / 1:1 / focus modes
        keep a tall fan-out readable. Replay and time travel sit on the same toolbar.
      </p>
      ...
      <div className="changelog">
        <article className="change">
          ...
          <p>
            Roots, Expensive, and Cause / Effects focus the subgraph you care about. Hover a node for
            self-time; click to select it in the tree and inspector.
          </p>
        </article>
        <article className="change">
          ...
          <p>
            Replay, Replay all, and the travel toggle live next to the graph. Follow{" "}
