  ...
  return (
    <section id="diff">
      ...
      <p className="sec-lead">
        ...
        <code> DiffSpecimen</code>, bump it, and the inspector shows the precise before → after —
        reference-only churn flagged separately from real changes. You can even edit the value from
        the panel and it reflects here.
      </p>
      <div className="card">
        <DiffSpecimen />
