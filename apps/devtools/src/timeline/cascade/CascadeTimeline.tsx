...
import { readTimelineTheme, type TimelineTheme } from "../view/timelineTheme.js";
  ...
  return (
    <div className="rl-cascade" ref={rootRef}>
      <div className="rl-cascade-toolbar">
        <button type="button" onClick={() => stepInteraction(-1)} title="Previous interaction">
          ◀
        </button>
        ...
        <button
          type="button"
          className={focusMode === "expensive" ? "active" : ""}
        ...
        <button
          type="button"
          className={focusMode === "roots" ? "active" : ""}
          onClick={() => setFocusMode("roots")}
        >
          Roots
        </button>
        <button type="button" onClick={() => focusDirection("upstream")} disabled={!selectedId}>
          ↑ cause
        </button>
        <button type="button" onClick={() => focusDirection("downstream")} disabled={!selectedId}>
          ↓ effects
        </button>
        <button
          type="button"
