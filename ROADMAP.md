...
- ✅ **`devtools`** — React 19 panel: semantic tree + **single-scroll inspector** with collapsible, auto-hiding sections (Why, Props explorer w/ change status, State, Hooks, Context, Effects, Renders, Source)
